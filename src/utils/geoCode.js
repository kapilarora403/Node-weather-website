...
const forecast = (lat, long, callback) => {
    ...
    request({url: forecastUrl, json: true}, (error, {body}) => {
        if(error) {
            ...
            There are ${(body.currently.precipProbability * 100).toFixed(2)}% chances of rain.`,
            `Tomorrow, it will be ${(body.hourly.data[0].summary).toLowerCase()} and ${body.hourly.data[0].temperature} degrees out.
